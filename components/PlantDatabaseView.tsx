    ...
    return (
        <div className="min-h-screen pb-32 max-w-md mx-auto relative bg-gradient-to-b from-[#ecfdf5] to-[#f0fdf4]">
            ...
            <div className="px-6 pt-12 pb-6 flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-slate-800 tracking-tight mb-1 leading-tight">Database</h1>
                    <p className="text-slate-500 font-medium text-sm">Find care info for 500+ species.</p>
                </div>
            </div>
