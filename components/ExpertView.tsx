...
export const ExpertView: React.FC<ExpertViewProps> = ({ currentView, onChangeView }) => {
  ...
  return (
    <div className="min-h-screen pb-32 max-w-md mx-auto relative px-6 pt-12">
      {/* Header */}
      <div className="clay-card p-8 mb-8 bg-gradient-to-br from-emerald-50 to-white border-white/50 flex items-center gap-4">
        <img src="/verdana-logo.png" alt="Verdant" className="h-12 w-auto object-contain" />
        <div>
          <h1 className="text-3xl font-bold text-slate-800 mb-1 leading-tight">Expert Help</h1>
          <p className="text-slate-600 text-sm italic">Get certified botanist advice.</p>
        </div>
      </div>
